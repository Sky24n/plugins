...
public class FlutterWebView implements PlatformView, MethodCallHandler, MyWebView.OnScrollChangedListener {
    ...
    private void scrollTop(MethodCall methodCall, Result result) {
    ...
    public void onScrollChanged(double scrollY) {
        ...
        arguments.put("scrollY", scrollY);
        methodChannel.invokeMethod("onScrollYChanged", arguments);
    }
}
